...
// flowing from the renderer into the embedded terminal's coding agent — both
...
/** What the renderer reports on every debounced selection/canvas/document change. */
...
/** Map of workspaceId → latest reported UI context. One instance lives for the runtime's lifetime. */
