...
//
// The only client is the stock frontend's upload hook (`useUploadImage`), which
...
// rather than pull a streaming multipart dependency into the daemon (which serves
