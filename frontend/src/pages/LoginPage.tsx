...
export const LoginPage = () => {
  ...
  return (
    <div
      className="relative min-h-screen flex flex-col items-center justify-center font-['Inter',system-ui,sans-serif] overflow-hidden"
      style={{
    ...
    >
      ...
      >
        {pendingInviteToken && (
          <div className="mb-6 flex items-start gap-3 rounded-[12px] border border-focused-content/20 bg-focused/60 px-3 py-2.5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-0.5 text-[11px] text-foreground-muted">Sign in to accept your team invite.</p>
            </div>
            <button
              type="button"
        ...
        <div className="mb-7 flex flex-col items-center gap-2">
          <img src={heartIcon} alt="" className="w-8 h-8 mb-1" />
          <h1 className="text-[22px] font-semibold text-foreground tracking-[-0.01em]">Welcome to Kanwas</h1>
        ...
        <form className="space-y-2.5" onSubmit={handleSubmit}>
          <input
            ...
            className="w-full appearance-none px-3.5 py-2.5 rounded-[10px] text-sm text-foreground bg-canvas placeholder:text-foreground-muted/60 border border-[#dcd2bf] focus:outline-none focus:ring-1 focus:ring-focused-content"
        ...
        <div className="relative my-5">
          ...
          <div className="relative flex justify-center">
            <span className="px-3 text-[12px] text-foreground-muted bg-canvas">or</span>
          </div>
        </div>
        ...
        <p className="mt-6 text-center text-[12px] text-foreground-muted">
          ...
          <Link to="/register" className="font-medium text-foreground hover:opacity-70 transition-opacity">
            Sign up
          </Link>
        </p>
      </div>
