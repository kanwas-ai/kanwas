...
export const FocusModeButton = memo(function FocusModeButton({ onClick, isActive }: FocusModeButtonProps) {
  return (
    <Tooltip.Provider delayDuration={0} skipDelayDuration={0}>
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          ...
          >
            <i className="fa-solid fa-expand text-[12px] text-foreground" />
          </button>
        </Tooltip.Trigger>
        {isActive && (
          <Tooltip.Portal>
